...
const RefundReturnPolicy = () => {
  return (
    <section className="w-full bg-gradient-to-b from-blue-50 via-white to-blue-50 min-h-screen py-16">
      <SEO title="Refund & Return Policy | Prints Basket" description="Read our refund and return policy for information on how to return items and request refunds." canonical="/refund-return-policy/" />
